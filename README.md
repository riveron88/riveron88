...
AWS Cloud Support Engineer focused on Linux infrastructure, hybrid cloud environments, troubleshooting, and cloud operations.

## 🔧 Core Technologies
- AWS (EC2, S3, IAM, VPC, EFS, CloudWatch, Lambda, Auto Scaling)
- Linux Administration (AlmaLinux, CentOS, Ubuntu)
